...
rotationY = getRandomNumber(-45, 45); 
...
// Prevent the default behavior to avoid the 300ms delay and other issues
event.preventDefault();
// Programmatically navigate to the homepage URL
window.location.href = homeButton.href;
});

// Still keep the click listener for desktops and as a fallback
homeButton.addEventListener('click', (event) => {
// This is handled by the browser for a normal click
});

console.log("Home button listeners attached.");
} else {
